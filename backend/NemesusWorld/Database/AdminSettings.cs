...
namespace NemesusWorld.Database
{
    ...
    class AdminSettings
    {
        ...
        //0 = Text-RP , 1 = SaltyChat (Muss selbstständig installiert werden, s. Tutorial auf dem Youtube-Kanal NemesusTV , 2 = RageMP Voice (Default)
        ...
        public AdminSettings()
        {
            ...
            dailyguesslimit = 0;
            nametag = 1;
            rpquiz = false; //True = Roleplay Quiz - False = Kein Roleplay Quiz
