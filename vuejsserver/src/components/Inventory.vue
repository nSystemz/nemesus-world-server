                                            ...
                                            <div class="col-md-12 col-md-offset-6">
                                                <div class="card2 card card-primary" style="max-height:2vw;" v-for="item in inventory1selected" :key="item.itemid" @click="moveItem2(item, 'left')">
                                                    <div class="inventorytext">
                                                        <img v-if="item.description != 'Granate' && item.description != 'BZGas' && item.description != 'Rauchgranate' && item.description != 'Molotowcocktail'" :src="getImgUrl(item.description)" width="5%" class="ml-2" style="transform: translateY(-0.1vw);" data-toggle="offcanvas">
