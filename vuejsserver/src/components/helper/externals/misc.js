...
//Max Clothes
export const maxShoesMen = 139;
export const maxShoesWomen = 149;
export const maxLegsMen = 192;
export const maxLegsWomen = 206;
export const maxTorsoMen = 213;
export const maxTorsoWomen = 247;
export const maxOberbekleidungMen = 525;
export const maxOberbekleidungWomen = 565;
export const maxTShirtMen = 208;
export const maxTShirtWomen = 252;
export const maxBagsMen = 99;
export const maxBagsWomen = 99;
export const maxGlassesMen = 55;
export const maxGlassesWomen = 57;
export const maxKopfbedeckungMen = 213;
export const maxKopfbedeckungWomen = 212;
...
export const invalidMenTop = [18, 51, 116, 194, 116, 274, 275, 276, 277, 278, 283, 284, 286, 287, 289, 291, 314, 315, 316, 317, 318, 319, 320, 333, 55, 54, 48, 186, 285, 288, 372, 397, 420, 442];
export const invalidMenLeg = [2, 84, 106, 107, 108, 109, 110, 113, 114, 121, 125, 127, 11, 30, 41, 44, 77, 115, 120, 145, 149];
export const invalidWomanLeg = [5, 13, 86, 113, 114, 115, 120, 121, 127, 131, 46, 79, 119, 122, 126, 132, 152, 157];
...
export const invalidMenShoe = [2, 11, 13, 33, 47, 67, 79, 84, 85, 17, 34, 83, 91, 90, 92];
...
export const invalidMenMask = [91, 120, 121, 132, 139, 140, 141, 135, 177, 180, 201, 209, 212, 213];
export const invalidWomenMask = [28, 38];
export const invalidWomanOhrring = [0, 1, 2, 22, 25];
export const invalidManOhrring = [0, 1, 2];
